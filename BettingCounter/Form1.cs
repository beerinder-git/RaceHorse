...
namespace BettingCounter {
    public partial class Form1 : Form {
        ...
        private void SetupRaceTrack() {
            ...
            punters[0] = pFactory.getPunter("Jim",MaximumBet,JimBet); //getting Jim object from factory class
            punters[1] = pFactory.getPunter("Roger", MaximumBet, RogerBet); //getting Roger object from factory class
            punters[2] = pFactory.getPunter("Mike", MaximumBet, MikeBet); //getting Mike object from factory class
        ...
        private void Bets_Click(object sender, EventArgs e) {
            ...
            if (JimButton.Checked) {
                PunterNum = 0;
            }
            if (RogerRButton.Checked) {
                PunterNum = 1;
            }
            if (MikeRButton.Checked) {
                PunterNum = 2;
            }
        ...
        private void race_Click(object sender, EventArgs e) {
            ...
            if (punters[0].busted && punters[1].busted && punters[2].busted){  //stop punters from betting if they run out of cash
